...
void All_Init()
{
    uart_init(UART_0, 9600, UART0_TX_P14_0, UART0_RX_P14_1);//串口初始化
//    lcd_init();//lcd屏幕初始化
    UI_Init();//UI初始化
    ...
    gtm_pwm_init(ATOM0_CH6_P02_6, 17000,  0);//ATOM 0模块的通道4 使用P02_4引脚输出PWM  PWM频率50HZ  占空比百分之0/GTM_ATOM0_PWM_DUTY_MAX*100  GTM_ATOM0_PWM_DUTY_MAX宏定义在zf_gtm_pwm.h
    gtm_pwm_init(ATOM0_CH7_P02_7, 17000,  0);
    gtm_pwm_init(ATOM0_CH1_P33_9, 50, 850);//舵机初始化
